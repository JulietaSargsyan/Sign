...
const Footer = () => (
    <footer className={styles.footer}>
      <p>&copy; 2025 All rights reserved. Sign Digital</p>
      ...
      <Link className={styles.social} href="https://www.instagram.com/sign_digital_design_studio/" target="_blank" rel="noopener noreferrer">Instagram</Link>
    </footer>
  );
